...
<div id="intro" class="section scrollspy">
    <div class="container">
        <div class="row">
            <div  class="col s12">
                <h2 class="center header text_h2">  <span class="span_h2">ThingsMind </span> is an IoT platform which enables IoT players of any scale to  <span class="span_h2"> manage, monitor and maintain </span> their  <span class="span_h2">IoT devices</span> effortlessly in a totally customisable and automatic way.
                  </h2>
            </div>
            ...
            <div  class="col s12 m4 l4">
                <div class="center promo promo-example">
                    ...
                    <p class="light center">Helps you speed up your development while we take care of maintining and monitoring your million devices across the world.</p>
                </div>
            </div>
            <div class="col s12 m4 l4">
                <div class="center promo promo-example">
                    <i class="mdi-social-group"></i>
                    <h5 class="promo-caption">Work Force Reduction</h5>
                    <p class="light center">As we help you manage your million devices you can reduce the amount of work force. This way we keep it easier on you.</p>
            ...
            <div class="col s12 m4 l4">
                <div class="center promo promo-example">
                    ...
                    <h5 class="promo-caption">Auto on-boarding</h5>
                    <p class="light center">Auto onboarding of all the IoT devices.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="parallax-container">
    <div class="parallax"><img src="${pageContext.request.contextPath}/resources/img/P1.jpg"></div>
</div>
...
<footer id="contact" class="page-footer default_color scrollspy">
    <div class="container">  
        <div class="row">
            ...
            <div class="col l3 s12">
                <h5 class="white-text">KnightsTeam</h5>
                <ul>
            ...
            <div class="col l3 s12">
                ...
                <ul>
                    ...
                    <li>
                        <a class="white-text" href="https://www.facebook.com/Knights">
    ...
    <div class="footer-copyright default_color">
        <div class="container">
            Made by <a class="white-text" href="http://joashpereira.com">Knights Team</a>.
        </div>
    </div>
</footer>
    ...
    <!--  Scripts-->
    <script src="${pageContext.request.contextPath}/resources/min/plugin-min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/min/custom-min.js"></script>
